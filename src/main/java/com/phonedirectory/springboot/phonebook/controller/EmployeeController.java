...
public class EmployeeController {
    ...
    @GetMapping("/adduser/all")
    public List<EmployeeModel> getAllEmployeesForAddUser(){
        return service.getAllEmployeesForAddUser();
    }

    @GetMapping("/edituser/all")
    public List<EmployeeModel> getAllEmployeesForEditUser(){
        return service.getAllEmployeesForUpdateUser();
    }

    @GetMapping("/{business_id}/search/all")
    ...
    @GetMapping("/{business_id}/search/id")
    ...
    @GetMapping("/{business_id}/search/name")
    ...
    @GetMapping("/{business_id}/search/phone")
    ...
    @GetMapping("/{business_id}/search/email")
    ...
    @GetMapping("/{business_id}/designation/{designation}")
